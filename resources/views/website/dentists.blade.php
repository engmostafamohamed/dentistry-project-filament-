      ...
      <section id="subheader" class="bg-color-op-1 text-center">
        <div class="container relative z-2">
          <div class="row align-items-center">
            <div class="col-lg-12">
              <h1 class="wow fadeInUp" data-i18n="our_dentists">Our Dentists</h1>
              <div class="border-bottom my-3"></div>
              <ul class="crumb wow fadeInDown">
                <li><a href="{{ route('home') }}" data-i18n="home">Home</a></li>
                <li class="active" data-i18n="our_dentists">Our Dentists</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section>
        <div class="container">
          <div class="row g-4 gy-5">
            <div class="col-md-12">
              <div class="bg-light rounded-1 relative overflow-hidden">
                <div class="abs num-position bottom-0 p-5 fs-150 fw-bold op-1 lh-1 id-color">
                  1
                </div>
                <div class="row g-0 align-items-center">
                  <div class="col-md-4">
                    <img src="{{ asset('website/images/team/1.webp') }}" class="w-100 rounded" alt="" />
                  </div>
                  <div class="col-md-8">
                    <div class="h-100 p-40">
                      <h3 class="mb-0">Dr. Sarah Bennett</h3>
                      <p class="id-color">Lead Dentist</p>
                      ...
                      <ul class="ul-check">
                        <li>
                          “Top Dentist in Manhattan” – New York Dental Journal
                          (2022)
                        </li>
                        <li>
                          American Academy of Cosmetic Dentistry Excellence
                          Award (2021)
                        </li>
                      </ul>

                      <div class="sc-icons mt-4">
            ...
            <div class="col-md-12">
              <div class="bg-light rounded-1 relative overflow-hidden">
                ...
                <div class="row g-0 align-items-center">
                  <div class="col-md-4">
                    <img src="{{ asset('website/images/team/2.webp') }}" class="w-100 rounded" alt="" />
                  </div>
                  <div class="col-md-8">
                    <div class="h-100 p-40">
                      <h3 class="mb-0">Dr. Maya Lin</h3>
                      <p class="id-color">Cosmetic Dentist</p>
                      ...
                      <ul class="ul-check">
                        <li>
                          Best Periodontist – Pennsylvania Dental Association
                          (2023)
                        </li>
                        <li>
                          Clinical Research Award – American Dental
                          Association (2020)
                        </li>
                      </ul>
            ...
            <div class="col-md-12">
              <div class="bg-light rounded-1 relative overflow-hidden">
                ...
                <div class="row g-0 align-items-center">
                  <div class="col-md-4">
                    <img src="{{ asset('website/images/team/3.webp') }}" class="w-100 rounded" alt="" />
                  </div>
                  <div class="col-md-8">
                    <div class="h-100 p-40">
                      <h3 class="mb-0">Dr. Michael Reyes</h3>
                      <p class="id-color">Pediatric Specialist</p>

                      <h4>Qualification</h4>
                      <p>
                        Bachelor of Dental Surgery (BDS), University of
                        Mumbai; Master of Dental Surgery (MDS) in Orthodontics
                      </p>
                      ...
                      <ul class="ul-check">
                        ...
                        <li>
                          Excellence in Dental Practice – Indian Dental
                          Association (2022)
                        </li>
                      </ul>
            ...
            <div class="col-md-12">
              <div class="bg-light rounded-1 relative overflow-hidden">
                ...
                <div class="row g-0 align-items-center">
                  <div class="col-md-4">
                    <img src="{{ asset('website/images/team/4.webp') }}" class="w-100 rounded" alt="" />
                  </div>
                  <div class="col-md-8">
                    <div class="h-100 p-40">
                      <h3 class="mb-0">Dr. James Carter</h3>
                      <p class="id-color">Dental Hygienist</p>
                      ...
                      <ul class="ul-check">
                        <li>
                          American College of Prosthodontists Educator of the
                          Year (2020)
                        </li>
    ...
    <div id="extra-content">
      ...
      <div>
        <i class="icofont-envelope me-2 op-5"></i><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
          data-cfemail="8ae9e5e4feebe9fecaeeefe4fee3ebe9ebf8efa4e9e5e7">[email&#160;protected]</a>
      </div>

...
<body>
                        ...
                        <div class="de-flex sm-pt10">
                            ...
                            <div class="de-flex-col">
                                <div class="menu_side_area">
                                    <a href="{{ route('booking') }}" class="btn-main fx-slide"><span>Book Appointment</span></a>
    ...
    <div class="no-bottom no-top" id="content">
      ...
      {{--  <section id="subheader" class="bg-color-op-1 text-center">
        <div class="container relative z-2">
          <div class="row align-items-center">
            <div class="col-lg-12">
              <h1 class="wow fadeInUp">General Dentistry</h1>
              <div class="border-bottom my-3"></div>
              <ul class="crumb wow fadeInDown">
                <li><a href="{{ route('booking') }}">Home</a></li>
                <li class="active">General Dentistry</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-6">
              <div class="relative">
                <div class="w-100 pe-5 pb-5 wow scaleIn">
                  <img src="{{ asset('website/images/misc/l1.webp') }}" class="w-100 rounded-1" alt="" />
                </div>
                <img src="{{ asset('website/images/misc/s1.webp') }}" class="w-40 rounded-1 abs end-0 bottom-0 z-2 soft-shadow wow scaleIn"
            ...
            <div class="col-lg-6">
              <div class="ps-lg-3">
                ...
                <p class="mb-0 wow fadeInUp" data-wow-delay=".6s">
                  ...
                  issues. Whether youre coming in for a routine check-up or
            ...
            <div class="col-lg-4 col-md-6">
              <div class="border-gray p-40 h-100 rounded-1">
                <div class="relative wow fadeInUp">
                  ...
                  <p class="mb-0">
                    Keep your teeth and gums healthy with regular check-ups
                    and cleanings.
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="border-gray p-40 h-100 rounded-1">
                <div class="relative wow fadeInUp">
                  ...
                  <p class="mb-0">
                    Natural-looking solutions to treat cavities and restore
            ...
            <div class="col-lg-4 col-md-6">
              <div class="border-gray p-40 h-100 rounded-1">
                <div class="relative wow fadeInUp">
                  ...
                  <p class="mb-0">
                    Comfortable, gentle removal of damaged or problematic
                    teeth.
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="border-gray p-40 h-100 rounded-1">
                <div class="relative wow fadeInUp">
                  ...
                  <p class="mb-0">
                    Save infected teeth with this pain-relieving, tooth-saving
                    procedure.
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="border-gray p-40 h-100 rounded-1">
                <div class="relative wow fadeInUp">
                  ...
                  <p class="mb-0">
                    Non-surgical and deep-cleaning options to treat gingivitis
                    and periodontitis.
                  </p>
                </div>
              </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-6 position-lg-absolute right-half h-100">
                ...
                <div class="image" data-bgimage="url(images/misc/s5.webp) center"></div>
              </div>
              <!-- Text -->
              <div class="col-lg-6">
                <div class="me-lg-3">
                  <div class="py-5 my-5 me-lg-3">
                    ...
                    <div class="row g-4">
                      <div class="col-lg-8 col-md-8 col-sm-6">
                        <ul class="ul-check fw-600 text-white mb-4 wow fadeInUp" data-wow-delay=".6s">
      ...
      <section class="bg-color text-light pt-50 pb-50">
        <div class="container">
          <div class="row g-4 align-items-center">
            <div class="col-md-9">
              <h3 class="mb-0 fs-32">Ready to Book Your Appointment?</h3>
              <p class="mb-0">
                Contact us today to schedule your visit and take the first
                step toward a healthier smile.
              </p>
            </div>
            <div class="col-lg-3 text-lg-end">
              <a class="btn-main fx-slide btn-line" href="{{ route('booking') }}"><span>Book Appointment</span></a>
            </div>
          </div>
        </div>
      </section>
  ...
  <div id="extra-wrap" class="text-light">
    ...
    <div id="extra-content">
      ...
      <ul class="ul-check">
        <li>
          <a href="{{ route('service-general-dentistry') }}">General Dentistry</a>
        </li>
        <li>
          <a href="{{ route('service-cosmetic-dentistry') }}">Cosmetic Dentistry</a>
        </li>
        <li>
          <a href="{{ route('service-pediatric-dentistry') }}">Pediatric Dentistry</a>
        </li>
        <li>
          <a href="{{ route('service-restorative-dentistry') }}">Restorative Dentistry</a>
        </li>
        <li>
          <a href="{{ route('service-preventive-dentistry') }}">Preventive Dentistry</a>
        </li>
      ...
      <div>
        <i class="icofont-envelope me-2 op-5"></i><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
          data-cfemail="6d0e0203190c0e192d09080319040c0e0c1f08430e0200">[email&#160;protected]</a>
      </div>

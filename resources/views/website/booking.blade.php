                    ...
                    <div class="col-md-12">
                        <div class="header-inner">
                            <div class="de-flex sm-pt10">
                                ...
                                <div class="de-flex-col">
                                    <div id="languageBtn">
                                        <i class="fa-solid fa-globe fs-4 id-color"></i>
                                    </div>
                                    <div class="menu_side_area">
                                        <button
                                            class="btn-main whats-btn rounded-circle  bg-success fx-slide d-inline-flex justify-content-center align-items-center gap-2 whatsapp-link">
                                            <i class="fs-20 fa-brands fa-whatsapp"></i>
            ...
            <section id="subheader" class="bg-color-op-1 text-center">
                <div class="container relative z-2">
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <h1 class="wow fadeInUp" data-i18n="book_appointment">Book Appointment</h1>
            ...
            <section>
                <div class="container relative z-2">
                    <div class="row g-4 gx-5 justify-content-between">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="relative">
                                                <select name="service" id="service" class="form-control">
                                                    <option disabled selected value data-i18n="select_service">Select Service</option>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div id="date" class="relative input-group date" data-date-format="mm-dd-yyyy">
                                                ...
                                                <input class="form-control" data-i18n="select_date" placeholder="select_date" value="" name="date" type="text">
                                        ...
                                        <div class="col-lg-12">
                                          <div id="submit">
                                            <input type="submit" id="send_message" data-i18n="send_message" value="Send Appointment" class="btn-main">
                                          </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="h-100 rounded-1 relative" data-bgimage="url(images/misc/s5.webp) center" >
                                <div class="bg-blur text-light shadow-1 abs start-10 bottom-10 p-4 rounded-1 overflow-hidden z-2" data-wow-delay=".5s">
                                    <div class="d-flex justify-content-center">
                                        <i class="fs-60 text-white fa-solid fa-clock"></i>
                                        <div class="ms-3">
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 col-sm-6 order-lg-2 order-sm-1">
                        <div class="widget">
                            ...
                            <div class="fw-bold text-white" data-i18n="call_us"><i class="icofont-phone me-2 id-color"></i >Call Us</div>
                            +1 123 456 789

                            <div class="spacer-20"></div>

                            <div class="fw-bold text-white" data-i18n="send_message"><i class="icofont-envelope me-2 id-color"></i>Send a Message</div>
    ...
    <div id="extra-wrap" class="text-light">
        ...
        <div id="extra-content">
            ...
            <div><i class="fa-solid fa-envelope me-2 op-5"></i><a href="/cdn-cgi/l/email-protection"
                    class="__cf_email__"
                    data-cfemail="d3b0bcbda7b2b0a793b7b6bda7bab2b0b2a1b6fdb0bcbe">[email&#160;protected]</a> </div>

...
<body>
        ...
        <div class="row g-4 gx-5 align-items-center">
                ...
                <div class="row g-4">
                  ...
                  <div class="col-lg-12">
                    <div class="rounded-1 overflow-hidden wow zoomIn" data-wow-delay=".3s">
                      <img src="{{ asset('website/images/misc/p2.webp') }}" class="w-100 wow scaleIn" alt="" data-wow-delay=".3s" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-6">
            <div class="me-lg-3">
              ...
              <a class="btn-main fx-slide wow fadeInUp" data-wow-delay=".8s" href="{{ route('pages.contact') }}"><span>Book
                  Appointment</span></a>
            </div>
          </div>
        </div>
          ...
          <div class="d-flex justify-content-center align-items-center mx-auto section-heading w-50">
            <div class="text-center">
              ...
              <p class="wow fadeInUp">
                Our experienced dental team is here to make every visit
                positive and personalized. With gentle hands and caring
                hearts.
              </p>
              ...
              <div class="col-lg-6">
                <div class="h-100">
                  <div class="relative wow fadeInUp">
                    ...
                    <p class="mb-0">
                      Skilled care backed by years of trusted dental
                      experience.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-lg-6">
                <div class="h-100">
                  <div class="relative wow fadeInUp">
                    ...
                    <p class="mb-0">
                      Custom care plans made to fit your smile and
                      lifestyle.
                    </p>
                  </div>
                </div>
            ...
            <div class="row gx-5">
                ...
                <div class="row">
                    ...
                    <div class="widget">
                        ...
                        <li><a href="{{ route('pages.services') }}" data-i18n="our_service">Our Services</a></li>
                        <li><a href="{{ route('pages.gallery') }}" data-i18n="gallery">Gallery</a></li>
                        <li><a href="{{ route('pages.about') }}" data-i18n="about_us">About Us</a></li>
                        <!-- <li><a href="{{ route('pages.blog') }}" data-i18n="blog">Blog</a></li> -->
                        <li><a href="{{ route('pages.contact') }}" data-i18n="contact">Contact</a></li>
                        </ul>
                    </div>
                    </div>
                    <div class="col-lg-6 col-sm-6">
                    <div class="widget">
                        ...
                        <li><a href="{{ route('service.cosmetic') }}" data-i18n="cosmetic">Cosmetic Dentistry</a></li>
                        <li><a href="{{ route('service.pediatric') }}" data-i18n="pediatric">Pediatric Dentistry</a></li>
                        <li><a href="{{ route('service.restorative') }}" data-i18n="restorative">Restorative Dentistry</a>
                        </li>
                        <li><a href="{{ route('service.preventive') }}" data-i18n="preventive">Preventive Dentistry</a></li>
  ...
  <div id="extra-wrap" class="text-light">
    ...
    <div id="extra-content">
      ...
      <ul class="ul-check">
        {{--  <li>
          <a href="{{ route('service.general') }}">General Dentistry</a>
        </li>  --}}
        <li>
          <a href="{{ route('service.cosmetic') }}">Cosmetic Dentistry</a>
        </li>
        <li>
          <a href="{{ route('service.pediatric') }}">Pediatric Dentistry</a>
        </li>
        <li>
          <a href="{{ route('service.restorative') }}">Restorative Dentistry</a>
        </li>
        <li>
          <a href="{{ route('service.preventive') }}">Preventive Dentistry</a>
        </li>
      ...
      <div>
        <i class="icofont-envelope me-2 op-5"></i><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
          data-cfemail="563539382237352216323338223f37353724337835393b">[email&#160;protected]</a>
      </div>

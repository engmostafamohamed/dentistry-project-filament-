            ...
            <div class="row g-4 gx-5 justify-content-center wow fadeInUp">
              <div class="col-lg-12">
                <div class="de-tab plain">
                  <ul
                    class="d-tab-nav mb-4 border-bottom pb-4 d-flex justify-content-between"
                  >
                    <li class="active-tab">General Care</li>
                    <li>Cosmetic Dentistry</li>
                    <li>Restorative Dentistry</li>
                    <li>Insurance &amp; Appointments</li>
                  </ul>
                  <ul class="d-tab-content text-start py-4">
                    <li>
                      <div class="accordion-section">
                        ...
                        <div
                          ...
                          id="accordion-a1"
                        >
                          It’s recommended to see your dentist every 6 months
                          for a routine check-up and cleaning, unless advised
                          otherwise.
                        </div>
                        <div
                          class="accordion-section-title"
                        ...
                        <div
                          ...
                          id="accordion-a2"
                        >
                          Call our office immediately. We offer same-day
                          emergency care for issues like severe pain, broken
                          teeth, or swelling.
                        </div>
                        <div
                          class="accordion-section-title"
                        ...
                        <div
                          ...
                          id="accordion-a3"
                        >
                          Absolutely! We provide gentle, friendly pediatric
                        ...
                        <div
                          ...
                          id="accordion-a4"
                        >
                          We offer dental implants, bridges, and dentures
                        ...
                        >
                          ...
                          whitening is safe and effective with long-lasting
                          results.
                        </div>
                      </div>
                    </li>
      ...
      <div id="extra-content">
        ...
        <div>
          ...
          ><a
            ...
            class="__cf_email__"
            data-cfemail="05666a6b716466714561606b716c64666477602b666a68"
            >[email&#160;protected]</a
          >
        </div>

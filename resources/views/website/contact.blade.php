...
<body>
                ...
                <div class="de-flex sm-pt10">
                    ...
                    <ul id="mainmenu">
                        ...
                        <ul>
                            ...
                            <!-- <li><a href="{{ route('pages.gallery') }}=">Testimonials</a></li> -->
                        </ul>
                        </li>
                        <!-- <li>
                        <a class="menu-item" href="{{ route('blog') }}" data-i18n="blog"
                            >Blog</a>
                        </li> -->
                        <li>
                        <a
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section id="subheader" class="bg-color-op-1 text-center">
                <div class="container relative z-2">
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <h1 class="wow fadeInUp" data-i18n="contact_us">Contact Us</h1>
                            <div class="border-bottom my-3"></div>
                            <ul class="crumb wow fadeInDown">
                                <li><a href="{{ route('home') }}" data-i18n="home">Home</a></li>
                                <li class="active" data-i18n="contact_us">Contact</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <section>
                <div class="container">
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="subtitle" data-i18n="contact_us_header">Get In Touch</div>
                            <h2 class="wow fadeInUp" data-i18n="contact_us_title">We are always ready to help you and answer your questions</h2>

                            <p data-i18n="contact_us_description">Whether you have a question, a suggestion, or just want to say hello, this is the place to do it. Please fill out the form below with your details and message, and we'll get back to you as soon as possible.</p>

                            <div class="row g-4 gx-5">
                                <div class="col-lg-6" >
                                    <div class="fw-bold text-dark" data-i18n="where_open_title"><i class="fa-solid fa-clock me-2 id-color-2" ></i>We're Open</div>
                                    Monday - Friday 08.00 - 18.00
                                </div>

                                <div class="col-lg-6" >
                                    <div class="fw-bold text-dark"  data-i18n="location_title"><i class="fa-solid fa-location-dot me-2 id-color-2"></i>Clinic Location</div>
                                    100 S Main St, New York, NY
                                </div>

                                <div class="col-lg-6" >
                                    <div class="fw-bold text-dark"  data-i18n="call_us_title"><i class="fa-solid fa-phone me-2 id-color-2"></i>Call Us Directly</div>
                                    +1 123 456 789
                                </div>

                                <div class="col-lg-6">
                                    <div class="fw-bold text-dark" data-i18n="message_title"><i class="fa-solid fa-envelope me-2 id-color-2"></i>Send a Message</div>
                                    <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="680b07061c090b1c280c0d061c01090b091a0d460b0705">[email&#160;protected]</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="p-40 bg-color-op-1 rounded-1">
                                <h3 data-i18n="contact_us_header">Get In Touch</h3>
            ...
            <div class="row gx-5">
                ...
                <div class="row">
                    ...
                    <div class="widget">
                        ...
                        <li><a href="{{ route('services.restorative') }}" data-i18n="restorative">Restorative Dentistry</a>
                        </li>
    ...
    <div id="extra-wrap" class="text-light">
        ...
        <div id="extra-content">
            ...
            <div><i class="icofont-envelope me-2 op-5"></i><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7a1915140e1b190e3a1e1f140e131b191b081f54191517">[email&#160;protected]</a> </div>
    ...
    <!-- Javascript Files
    ================================================== -->
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="{{ asset('website/js/plugins.js') }}"></script>
    <script src="{{ asset('website/js/designesia.js') }}"></script>
    <script src="{{ asset('website/js/validation-contact.js') }}"></script>
